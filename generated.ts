// Generated by @wagmi/cli@1.0.0 on 5/13/2023 at 5:36:44 PM
import {
  useContractRead,
...
export const aboutTimerABI = [
  {
    ...
    type: 'constructor',
    inputs: [
      { name: 'BOBx_', internalType: 'contract ISuperToken', type: 'address' },
    ],
  },
  {
    type: 'event',
...
export const aboutTimerAddress = {
  31337: '0x8a5592b0E95767886642269AEb0B7A80dAa22c8f',
} as const
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link aboutTimerABI}__ and `functionName` set to `"BOBx"`.
 *
 *
 */
export function useAboutTimerBoBx<
  TFunctionName extends 'BOBx',
  TSelectData = ReadContractResult<typeof aboutTimerABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof aboutTimerABI, TFunctionName, TSelectData>,
