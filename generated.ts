// Generated by @wagmi/cli@1.0.0 on 5/13/2023 at 4:10:54 PM
import {
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link aboutTimerABI}__ and `functionName` set to `"zkBobx"`.
 */
export function useAboutTimerZkBobx<
  TFunctionName extends 'zkBobx',
  TSelectData = ReadContractResult<typeof aboutTimerABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof aboutTimerABI, TFunctionName, TSelectData>,
